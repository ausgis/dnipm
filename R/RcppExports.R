...
bezierInterpolation <- function(x, y, xs, ys, zs, NA_rm = TRUE) {
    .Call(`_dnipm_bezierInterpolation`, x, y, xs, ys, zs, NA_rm)
}

bezierInterp <- function(xy, xs, ys, zs, NA_rm = TRUE) {
    .Call(`_dnipm_bezierInterp`, xy, xs, ys, zs, NA_rm)
}
